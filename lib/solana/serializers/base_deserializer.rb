...
module Solana
  module Serializers
    ...
    autoload :TransactionDeserializer, 'solana/serializers/transaction_deserializer'
    autoload :MessageDeserializer, 'solana/serializers/message_deserializer'
    autoload :InstructionDeserializer, 'solana/serializers/instruction_deserializer'
    autoload :AddressLookupTableDeserializer, 'solana/serializers/address_lookup_table_deserializer'
