...
num_addresses, _ = Solace::Utils::Codecs.decode_compact_u16(io)
...
addresses = Array.new(num_addresses).map do
  ...
  num_writable, _ = Solace::Utils::Codecs.decode_compact_u16(io)
  writable_indexes = io.read(num_writable).unpack("C*")

  num_readonly, _ = Solace::Utils::Codecs.decode_compact_u16(io)
